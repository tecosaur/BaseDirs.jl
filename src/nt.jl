...
const RELEVANT_FOLDERS =
    (:Windows, :ProgramData, :Programs, :CommonPrograms,
...
function relevantfolders()
    ...
    rf.Downloads = knownfolder(:Downloads, "Downloads")
    rf.Documents = knownfolder(:Documents, "Documents")
    rf.Music = knownfolder(:Music, "Music")
    rf.Pictures = knownfolder(:Pictures, "Pictures")
    rf.Videos = knownfolder(:Videos, "Videos")
